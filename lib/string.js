...
exports.interpolate = (template, data) => {
  return _.reduce(template.match(regexes.TEMPLATE_INTERPOLATION), (accumulator, match, index, collection) => {
    const interpolation = regexes.execute(regexes.BOUNDED_INTERPOLATION, match)
